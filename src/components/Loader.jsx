...
function Loader({ text }) {
    ...
    return (
        <div className="bg-neutral-800 text-neutral-200 transition ease-out w-full min-h-dvh flex place-items-center justify-center p-4 mobile:px-4 tablet:px-8 laptop:px-16">
