...
function Unauthorized() {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-neutral-100 dark:bg-neutral-900 text-black dark:text-white text-center p-6">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mt-2">You need to log in to access this page.</p>

            <Link to="/login" className="mt-6 px-6 py-3 text-white bg-green-600 rounded-lg flex items-center gap-2 hover:bg-green-700 transition">
