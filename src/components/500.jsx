...
function ServerError() {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-neutral-900 text-white text-center p-6">
            ...
            <p className="text-neutral-400 mt-2">Oops! Something went wrong on our side.</p>

            <Link to="/" className="mt-6 px-6 py-3 bg-red-600 rounded-lg flex items-center gap-2 hover:bg-red-700 transition">
