...
function Card({
    ...
    return (
        <div className="flex flex-col p-5 bg-neutral-200 dark:bg-neutral-800 text-black dark:text-white rounded-lg shadow-md shadow-neutral-100 dark:shadow-neutral-900 h-fit w-full max-w-md transition hover:scale-105 hover:bg-neutral-300 dark:hover:bg-neutral-700">
            ...
            <p className="text-neutral-700 dark:text-neutral-300 mt-1">{description}</p>

            {/* Code Section (if available) */}
            {code && (
                <div className="flex items-center bg-neutral-200 dark:bg-neutral-800 p-2 rounded mt-3">
                    <code className="text-green-600 dark:text-green-400 flex-1">{code}</code>
                    <button
                        onClick={copyCode}
                        className="ml-2 text-gray-600 dark:text-gray-400 hover:text-green-400"
                    >
                        <Clipboard size={18} />
                    </button>
                </div>
            ...
            <div className="flex items-center justify-between gap-3 mt-4 border-t border-neutral-300 dark:border-neutral-700 pt-3">
            ...
            {/* Copied notification */}
            {copied && (
                <div className="absolute bottom-5 right-5 bg-green-600 text-black dark:text-white px-4 py-2 rounded shadow">
                    Code Copied!
                </div>
            )}
        </div>
